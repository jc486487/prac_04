...
# uses list comprehension to create a list of all of the full_names
# in lowercase format
lowercase_full_names = [name.lower() for name in full_names]
print(lowercase_full_names)

almost_numbers = ['0', '10', '21', '3', '-7', '88', '9']
# uses list comprehension to create a list of integers
# from the above list of strings
numbers = [int(num) for num in almost_numbers]
print(numbers)

# uses list comprehension to create a list of only the numbers that are
# greater than 9 from the numbers (not strings) you just created
greater = [num for num in numbers if num > 9]
print(greater)